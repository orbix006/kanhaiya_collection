import { getLeadsAdmin } from "@/lib/data/cms";
import { LeadsInbox } from "@/components/admin/inbox/leads-inbox";
import { Users, Sparkles } from "lucide-react";

export const dynamic = "force-dynamic";

export default async function AdminLeadsInboxPage() {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-border/60">
        <div>
          ...
          <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-foreground">
            Newsletter Leads & Subscriptions
          </h1>
          <p className="text-xs sm:text-sm text-muted-foreground mt-1 max-w-2xl">
            Track customer subscriptions captured via the storefront footer, marketing popups, and product inquiries.
          </p>
        </div>
